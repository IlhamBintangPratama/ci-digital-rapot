                ...
                <div class="col-lg-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <form method="post" action="<?php echo base_url(); ?>ps/datasiswa">
                            ...
                            <table class="mb-0 table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="<?php echo base_url()?>ps/cetakrapot/<?= $this->input->post('semester')?>/<?= $key->nis; ?>">Cetak Nilai</a></td>
                                    </tr>
