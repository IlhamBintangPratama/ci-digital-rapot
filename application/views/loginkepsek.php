	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo base_url('LoginKepsek/login') ?>" method="POST">
					...
					<div class="container-login100-form-btn">
						...
						<a href="<?= base_url("resetPassword?type=kepsek") ?>">Reset Password</a>
					</div>
				</form>
			</div>
		</div>
