            ...
            <div class="row">
                ...
                <script>
                    function set_href() {
                        ...
                        document.getElementById('semester1').href = "<?php echo base_url('murid/jenis/1') ?>" + "/" + tahun_ajaran.value;
                        document.getElementById('semester2').href = "<?php echo base_url('murid/jenis/2') ?>" + "/" + tahun_ajaran.value;
                    }
                </script>
            </div>
        </div>
