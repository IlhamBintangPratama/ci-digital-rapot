...
<body id="page-top">
    ...
    <section class="page-section portfolio bg-white mt-5" id="portfolio">
        <div class="container">
            ...
            <h2 class=" text-center text-secondary text-uppercase  mb-3">Cek Rapot</h2>
        ...
        <script>
            ...
            document.getElementById('semester1').href = "<?php echo base_url('murid/hasilraport/1') ?>"+"/"+tahun_ajaran.value;
            document.getElementById('semester2').href = "<?php echo base_url('murid/hasilraport/2') ?>"+"/"+tahun_ajaran.value;
            }
        </script>
    </section>
    <!-- Portfolio Section-->
