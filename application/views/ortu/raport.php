      ...
      <?php $this->load->view('partialsortu/navbar'); ?>
       ...
       <section class="page-section portfolio bg-white mt-5" id="portfolio">
            <div class="container">
                ...
                <h2 class=" text-center text-secondary text-uppercase  mb-3">Cek Rapor</h2>
                ...
                <script>
                    ...
                    document.getElementById('semester1').href = "<?php echo base_url('ortu/hasilraport/1') ?>"+"/"+tahun_ajaran.value;
                    document.getElementById('semester2').href = "<?php echo base_url('ortu/hasilraport/2') ?>"+"/"+tahun_ajaran.value;
                    }
                </script>
            </div>
        </section>
