...
<body id="page-top">
    ...
    <section class="page-section portfolio bg-white mt-5" id="portfolio">
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <a href="<?php echo base_url('ortu/hasil/1/') ?><?php echo $thn ?>">
                ...
                <!-- Portfolio Item 2-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <a href="<?php echo base_url('ortu/hasil/2/') ?><?php echo $thn ?>">
        ...
        <!-- Portfolio Item 3-->
        <div class="col-md-6 col-lg-4 mb-5">
            <a href="<?php echo base_url('ortu/hasil/3/') ?><?php echo $thn ?>">
        ...
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            <a href="<?php echo base_url('ortu/hasil/4/') ?><?php echo $thn ?>">
        ...
        <!-- Portfolio Item 5-->
        <a href="<?php echo base_url('ortu/hasil/9/') ?><?php echo $thn ?>">
        ...
        <!-- Portfolio Item 6-->
        <a href="<?php echo base_url('ortu/hasil/10/') ?><?php echo $thn ?>">
    ...
    ?>
        ...
        <div class="row">
            <!-- Portfolio Item 1-->
            <div class="col-md-6 col-lg-4 mb-5">
                <a href="<?php echo base_url('ortu/hasil/5/') ?><?php echo $thn ?>">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                        <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                        </div>
        ...
        <!-- Portfolio Item 2-->
        <div class="col-md-6 col-lg-4 mb-5">
            <a href="<?php echo base_url('ortu/hasil/6/') ?><?php echo $thn ?>">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
                    <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                        <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                    </div>
        ...
        <!-- Portfolio Item 3-->
        <div class="col-md-6 col-lg-4 mb-5">
            <a href="<?php echo base_url('ortu/hasil/7/') ?><?php echo $thn ?>">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
                    <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                        <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                    </div>
        ...
        <!-- Portfolio Item 4-->
        <a href="<?php echo base_url('ortu/hasil/8/') ?><?php echo $thn ?>"></a>
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
                <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                    <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
        ...
        <!-- Portfolio Item 5-->
        <a href="<?php echo base_url('ortu/hasil/11/') ?><?php echo $thn ?>"></a>
        <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
            <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal5">
                <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                    <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
        ...
        <!-- Portfolio Item 6-->
        <a href="<?php echo base_url('ortu/hasil/12/') ?><?php echo $thn ?>"></a>
        <div class="col-md-6 col-lg-4">
            <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
                <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                    <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
