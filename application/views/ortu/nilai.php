    ...
    <section class="page-section portfolio bg-white mt-5" id="portfolio">
        ...
        <script>
            function set_href() {
                ...
                document.getElementById('semester1').href = "<?php echo base_url('ortu/jenis/1') ?>" + "/" + tahun_ajaran.value;
                document.getElementById('semester2').href = "<?php echo base_url('ortu/jenis/2') ?>" + "/" + tahun_ajaran.value;
            }
        </script>
        </div>
    </section>
