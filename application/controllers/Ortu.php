...
class Ortu extends CI_Controller {
	...
	// 
	// $data['namasiswa'] = $this->db->query("SELECT * FROM tb_siswa,tb_rombel WHERE tb_siswa.id_rombel = tb_rombel.id_rombel and tb_siswa.nis = $nis")->result();
	// var_dump($data['namasiswa']);
	// die();
	...
	public function nilai()
	{
		...
		$this->load->view('ortu/nilai', $data);
	}
	...
	public function raport()
	{
		...
		$this->load->view('ortu/raport', $data);
	}
	...
	public function hasilraport()
	{
        ...
        $this->load->view('ortu/hasilraport', $data);
	}
